...
function getErrorMessage(error) {
  ...
  if (_axios.default.isAxiosError(error)) {
    var msg = (_b = (_a = error.response) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.message;
...
},{"axios":"../../node_modules/axios/index.js"}],"login.ts":[function(require,module,exports) {
"use strict";
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 12:
          ...
          message = (0, _errorHandler.default)(_context2.t0, 'Logout failed.');
          (0, _alerts.showAlert)({
            type: 'error',
            message: message
          });
 ...
 */
var bookAdventure = exports.bookAdventure = function bookAdventure(adventureId) {
  return __awaiter(void 0, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var _a, _b, res, result, message, _message;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
        ...
        case 3:
          res = _context.sent;
          if (!(res.data.status !== 'success' || !((_a = res.data.session) === null || _a === void 0 ? void 0 : _a.id))) {
            _context.next = 6;
            break;
          }
        ...
        case 8:
          ...
          if (result.error) {
            if ("development" === 'development' && result.error) {
              console.error('Stripe redirectToCheckout error:', result.error);
            }
            message = (_b = result.error.message) !== null && _b !== void 0 ? _b : 'Checkout failed. Please try again.';
            (0, _alerts.showAlert)({
              type: 'error',
              message: message
            });
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 8:
          _context.prev = 8;
          _context.t0 = _context["catch"](0);
          message = (0, _errorHandler.default)(_context.t0, 'Update failed.');
          (0, _alerts.showAlert)({
            type: 'error',
            message: message
          });
...
},{"axios":"../../node_modules/axios/index.js","../alerts":"alerts.ts","../utils/errorHandler":"utils/errorHandler.ts"}],"modules/handleSettingsForms.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initUserForm = exports.initPasswordForm = void 0;
 ...
 */
var initUserForm = exports.initUserForm = function initUserForm() {
  var _a;
...
var initPasswordForm = exports.initPasswordForm = function initPasswordForm() {
  return __awaiter(void 0, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
...
var _handleSettingsForms = require("./modules/handleSettingsForms");
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
/**
...
var initBooking = function initBooking() {
  ...
  bookBtn.addEventListener('click', function (e) {
    ...
    (0, _stripe.bookAdventure)(adventureId);
  });
};
